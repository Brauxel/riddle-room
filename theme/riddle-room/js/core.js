...
var top = $('.fireplace').css('top');
var window_width = $( window ).width();
/*alert(window_height);
$('.fireplace').css('top', 144);*/
...
/*$('#responsive-nav li a').click(function() {
	$('#responsive-nav').slideUp('fast');
...
$('#responsive-content .book-now').click(function() {
	$('html,body').animate({
		scrollTop: $('#responsive-content .about-us').offset().top
	},1500);
});